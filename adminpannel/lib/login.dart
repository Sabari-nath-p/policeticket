...
import 'package:adminpannel/home.dart';
...
class _signupState extends State<signup> {
                        ...
                        InkWell(
                          onTap: () {
                            if (nameText.text.isNotEmpty &&
                                ...
                                emailText.text.isNotEmpty) {
                              sendsignup(emailText.text, passwordText.text,
                                  nameText.text);
                            } else {
                              Fluttertoast.showToast(msg: "Please fill");
                            }
  ...
  sendlogin(String email, String password) {
    ...
    users.doc(email).get().then((value) async {
      //print(value.get("admin").toString());
      var js = json.decode(json.encode(value.data()));
      print(js["admin"]);
      print(js["password"]);
      if (value.exists) {
